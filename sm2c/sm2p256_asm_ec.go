...
type sm2Curve struct {
	newPoint func() *P256Point
	params   *elliptic.CurveParams
}

var sm2p256 = &sm2Curve{newPoint: NewP256Point}
...
func (curve *sm2Curve) pointFromAffine(x, y *big.Int) (p *P256Point, err error) {
	p = curve.newPoint()
...
func (curve *sm2Curve) pointToAffine(p *P256Point) (x, y *big.Int) {
	out := p.Bytes()
